...
test('admin dapat membuat dompet tanpa mengelola dompet pengguna lain', function () {
    $admin = User::factory()->create(['role' => 'admin', 'masa_aktif' => null]);
    Dompet::create(['user_id' => $admin->id, 'nama_dompet' => 'Cash', 'saldo' => 0, 'is_default' => true]);
    Dompet::create(['user_id' => $admin->id, 'nama_dompet' => 'Bank', 'saldo' => 0]);
    Dompet::create(['user_id' => $admin->id, 'nama_dompet' => 'E-Wallet', 'saldo' => 0]);
