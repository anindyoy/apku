            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        <tr><td class="py-2 pr-4">Buku kas</td><td class="px-4 py-2">Utama + 1 tambahan</td><td class="px-4 py-2">Bebas menambah</td></tr>
                        <tr><td class="py-2 pr-4">Dompet</td><td class="px-4 py-2">Utama + 1 tambahan</td><td class="px-4 py-2">Bebas menambah</td></tr>
                        <tr><td class="py-2 pr-4">Kelola transaksi pada buku kas dan dompet tambahan</td><td class="px-4 py-2">Terbatas</td><td class="px-4 py-2">Tersedia selama Premium aktif</td></tr>
